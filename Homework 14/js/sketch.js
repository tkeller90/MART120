...
function setup(){
  ...
  rectangleObject = new Rectangle(100, 50, 175, 100, 100, 135, 210);
    rectangleObject2 = new Rectangle(200, 300, 175, 30, 40, 135, 210);
    rectangleObject3 = new Rectangle(350, 50, 75, 100, 200, 135, 210);
